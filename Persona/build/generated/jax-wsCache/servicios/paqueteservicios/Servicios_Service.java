 ...
 * 
 */
@WebServiceClient(name = "servicios", targetNamespace = "http://paqueteServicios/", wsdlLocation = "http://localhost:8080/ESB/servicios?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIOS_QNAME = new QName("http://paqueteServicios/", "servicios");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ESB/servicios?wsdl");
    ...
    public Servicios getServiciosPort() {
        return super.getPort(new QName("http://paqueteServicios/", "serviciosPort"), Servicios.class);
    }
    ...
    public Servicios getServiciosPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://paqueteServicios/", "serviciosPort"), Servicios.class, features);
    }
